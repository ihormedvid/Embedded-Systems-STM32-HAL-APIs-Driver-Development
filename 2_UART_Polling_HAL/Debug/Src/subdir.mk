...
Src/%.o Src/%.su Src/%.cyclo: ../Src/%.c Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DUSE_HAL_DRIVER -DSTM32F411xE -c -I../Inc -I"D:/projects/stm_hal/2_UART_Polling_HAL/Drivers/CMSIS/Include" -I"D:/projects/stm_hal/2_UART_Polling_HAL/Drivers/CMSIS/Device/ST/STM32F4xx/Include" -I"D:/projects/stm_hal/2_UART_Polling_HAL/Drivers/STM32F4xx_HAL_Driver/Inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
